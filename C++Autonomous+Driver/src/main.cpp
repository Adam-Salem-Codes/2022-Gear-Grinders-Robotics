...
int* checkSpeed() {
  Inertial.calibrate();
  int xspeed = std::round(Inertial.acceleration(xaxis)),
 zspeed = std::round(Inertial.acceleration(xaxis));
    int speeds[] = {
    xspeed,
    zspeed
  };
...
void DriverControl(void) {
  ...
  while(true) {
    ...
    Controller1.Screen.clearScreen();
    Controller1.Screen.print("XSpeed: ");
    Controller1.Screen.print(speeds[0]);
    Controller1.Screen.newLine();
    Controller1.Screen.print(" ZSpeed: ");
    Controller1.Screen.print(speeds[1]);
  }
